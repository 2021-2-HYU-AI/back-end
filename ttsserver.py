...
cred = credentials.Certificate(
    "/Users/yunseok/Desktop/firebase_key.json")  # 경로 수정 필요
firebase_admin.initialize_app(cred)

# start google cloud storage
storage_client = storage.Client.from_service_account_json(
    '/Users/yunseok/Downloads/neon-net-333104-b3f13972ab4a.json')
...
if user == "엄마":
    upload_to_bucket(
        "mom/TTS.mp3", "/Users/yunseok/Downloads/TTS/TTS.mp3", "uploadtts")
    upload_to_bucket("mom/output.m3u8",
                     "/Users/yunseok/Downloads/TTS/output.m3u8", "uploadtts")
    tsCounter = len(glob.glob1("/Users/yunseok/Downloads/TTS", "*.ts"))
    for number in range(0, tsCounter):
        file_name = "output"+str(number)+".ts"
        upload_to_bucket("mom/output"+str(number)+".ts",
                         "/Users/yunseok/Downloads/TTS/output"+str(number)+".ts", "uploadtts")

elif user == "아빠":
    upload_to_bucket(
        "dad/TTS.mp3", "/Users/yunseok/Downloads/TTS/TTS.mp3", "uploadtts")
    upload_to_bucket("dad/output.m3u8",
                     "/Users/yunseok/Downloads/TTS/output.m3u8", "uploadtts")
    tsCounter = len(glob.glob1("/Users/yunseok/Downloads/TTS", "*.ts"))
    for number in range(0, tsCounter):
        file_name = "output"+str(number)+".ts"
        upload_to_bucket("dad/output"+str(number)+".ts",
                         "/Users/yunseok/Downloads/TTS/output"+str(number)+".ts", "uploadtts")
